...
function About({ match }) {
  const [about, setAbout] = useState([
    ...
    [pic, 'Robert Valdez III', 'I, Roberto V. Valdex III am a senior agent for Affordable Insurance of Texas. I\'ve been with the company since December of 2011. I\'m a Corpus Christi Native and am fluent in Spanish. I graduated with honors from W.B. Ray High School and went on to earn my Bachelor\'s Degree from The University of Texas at San Antonio. I\'ve been a licensed agent since 2010 and got my start in the insurance industry in 2003. I\'d love the opportunity to earn your business. Pregunta por mi si necesitas ayuda an espanol.'],
