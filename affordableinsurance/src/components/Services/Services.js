...
function Services({ match }) {
  const [services, setServices] = useState([
    ...
    [LocalShipping, 'Comercial Auto/Cargo','Motor truck Cargo Insurance provides insurance on the freight or commodity hauled by a for-hire trucker. It covers your liability for cargo that is lost or damaged due to causes such as fire, collision, or striking of a load. If your load is accidentally dumped on a roadway or waterway(removal expenses coverage) our coverage pays for the cost to remove debris or extra pollutants caused by the debris. We\'ll also pay for costs related to preventing further loss to damaged cargo. (Sue and labor coverage ), legal expenses in the defense or settlement of Claims\' and even freight charges the customer loses because of not delivering a load (Earned Freight Coverage)'],
    [BusinessCenter, 'Commercial Liability','This policy protects your business from financial loss should you be liable for property damage, personal, or advertising injury caused by your services, business operations or your employees. '],
    [Store, 'Commercial Property','Commercial Property policies cover your building and all of its contents, as well as any exterior ixtures associated with your business, such as a fence or outside sign. THe protection of your physical property and its contents extends to damages caused by fire, burst pipes, storms, vandalism, and explosions.'],
    [Waves, 'Flood','Insurance that cover rising water. The water can come from the ocean, a storm surge, A swelling river, or even an abundance of rain. This coverage comes from water outside the home not from a pipe burst inside the home.'],
    [HouseIcon, 'Home Owners','Is a type of ;property insurance that covers a private residence.  It is an insurance policy that combines various personal insurance protections, which can include losses occurring to one\'s home it\'s contents, loss of use (additional living expenses) or loss of other personal possessions of the homeowner, as well as liability insurance for accidents that may happen at the home or at the handsof the homeowner within the policy territory Additionally, homeowner\'s insurance provides financial protection against disasters. A standard home insurance policy insures the home itself along with the things kept inside.'],
    ...
    [Cloud, 'Windstorm','Insurance that cover any type of Wind Event. Hurricane or Tropical Storm or even any cold front. Simply any wind and hail event. These are policies for both personal and commercial purposes.'],
    [SupervisorAccount, 'Workers’ Comp','This insurance covers an employer\'s workers during the time and in the course of working for the company. This is a medical insurance coverage in case of an accident.'],
  ]);
